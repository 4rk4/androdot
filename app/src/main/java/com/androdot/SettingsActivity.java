...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate( Bundle savedInstanceState ) {
            ...
            bindPreferenceSummaryToValue( findPreference( "prefNom" ) );
            bindPreferenceSummaryToValue( findPreference( "prefPassword" ) );
            bindPreferenceSummaryToValue( findPreference( "prefUrl" ) );
            bindPreferenceSummaryToValue( findPreference( "prefNbArticles" ) );
        }
